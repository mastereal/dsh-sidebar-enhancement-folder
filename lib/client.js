// sidebar-enhancement-folder — Client half (browser bundle, __ModuleLoader__ contract)
...
window.__ModuleLoader__.load({ id: 'sidebar-enhancement-folder', factory: (require) => {
  var module = { exports: {} };
  var exports = module.exports;

  function dbg() {
    var args = Array.prototype.slice.call(arguments);
    args.unshift('[sidebar-enhancement-folder]');
  ...
  var MOUNT_ATTR = 'data-sidebar-enhancement-folder-mount';
  ...
  function makeButton(paneTab, path, sessionId) {
    ...
    btn.addEventListener('click', function (e) {
      ...
      fetch('/sidebar-enhancement-folder/reveal?path=' + encodeURIComponent(p) +
  ...
  var apply = function (ctx) {
    ...
    var reg = slots.inject('shell.overlay', function () {
      return slots.register({
        name: 'shell.overlay',
        id: 'sidebar-enhancement-folder',
        order: 5,
        label: '打开所在文件夹',
        registrant: 'sidebar-enhancement-folder'
